  ...
  <div class="item-box">
    ...
    <div class="detail-info-box">
      ...
      <device-desc-box :deviceName="deviceData.deviceName || '-'"
                       ...
                       :deviceIP="deviceData.deviceIP || '-' + ':' + deviceData.devicePort || '-'">
      </device-desc-box>
      <!--<ul class="right-box">-->
...
export default {
  ...
  mounted () {
    if (this.deviceMsg !== '' && this.deviceMsg !== undefined) {
      console.log('mounted Gate deviceMsg = ' + JSON.stringify(this.deviceMsg))
      ...
      if (deviceId !== '') {
        queryDeviceInfoByCode(deviceId).then(res => {
          if (res) {
            ...
            that.videoplayData = {}
            if (videoParam) {
              console.log('Gate videoParam=' + JSON.stringify(videoParam))
  ...
  watch: {
    deviceMsg: function (val, oldVal) {
      if (this.deviceMsg !== '' && this.deviceMsg !== undefined) {
        console.log('watch Gate deviceMsg = ' + JSON.stringify(this.deviceMsg))
        this.initData()
        this.queryDeviceInfo(this.deviceMsg.deviceId)
      }
    }
