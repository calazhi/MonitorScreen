...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    // 判断视频ocx是否下载  judgeVideoocxDownloaded
    judgeVideoocxDownloaded (state, isDownloaded) {
      state.is_videoocx_downloaded = isDownloaded
    },
    // 判断呼叫ocx是否下载  judgeCallocxDownloaded
    judgeCallocxDownloaded (state, isDownloaded) {
      state.is_callocx_downloaded = isDownloaded
    },
    // 设置当前网络状态
    setNetworkState (state, isOut) {
      state.is_network_outage = isOut
    },
  }
})
